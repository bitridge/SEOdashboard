...
export default function Edit({ auth, user, roles }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-white">Edit User</h2>}
        >
            ...
            <div className="py-6">
                <div className="bg-gray-900 rounded-lg overflow-hidden p-6">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <InputLabel htmlFor="password" value="Password (leave blank to keep unchanged)" className="text-white" />
                            <TextInput
                                id="password"
                                type="password"
                                name="password"
